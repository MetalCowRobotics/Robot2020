...
public class IMUFixed extends GyroBase implements Gyro, Sendable {
  ...
  private static class AcquireTask implements Runnable {
    private IMUFixed imu;

    public AcquireTask(IMUFixed imu) {
      this.imu = imu;
    }
   ...
   */
  public IMUFixed(IMUAxis yaw_axis, SPI.Port port, ADIS16470CalibrationTime cal_time) {
    m_yaw_axis = yaw_axis;
