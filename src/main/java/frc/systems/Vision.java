...
public class Vision {
    ...
    //MCRCommand turnCW =  new SequentialCommands(new TimedCommandSet(new TurnDegrees(turnAdjustment), 2),new CommandPause(.2));
    //MCRCommand turnCCW = new SequentialCommands(new TimedCommandSet(new TurnDegrees(-turnAdjustment), 2),new CommandPause(.2));
