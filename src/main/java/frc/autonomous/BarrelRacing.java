...
public class BarrelRacing implements MCRCommand {
    ...
    public BarrelRacing() {
        ...
        MCRCommand firstLoop = new SequentialCommands(new DriveInches(1, 90), new CurvatureDrive("RIGHT", 361, 42, 0.8));
        ...
        MCRCommand secondLoop = new SequentialCommands( new DriveInches(1, 73), new CurvatureDrive("LEFT", 305, 42, 0.8));
       ...
       // mission = new SequentialCommands(
        ...
        mission = new SequentialCommands(firstLoop, secondLoop, new DriveInches(1, 70), new CurvatureDrive("LEFT", 228, 48, 0.7), new DriveInches(1, 275));
