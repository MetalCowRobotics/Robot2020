...
public class BarrelRacing implements MCRCommand {
    ...
    public BarrelRacing() {
        ...
        MCRCommand firstLoop = new SequentialCommands(new DriveInches(1, 108.1), new CurvatureDrive("right", 360, 48, 0.7));
        ...
        MCRCommand secondLoop = new SequentialCommands( new DriveInches(1, 91.5), new CurvatureDrive("left", 360, 60, 0.7));
